...
angular.module("partials/cv.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("partials/cv.html",
    ...
    "        <a ng-href=\"{{ prefixLink }}/cv/english\" ng-bind-html=\"cv.data.english.tag\"></a>\n" +
    "      </li>\n" +
    "      <li ng-class=\"{active: cv.params.language == 'spanish'}\">\n" +
    "        <a ng-href=\"{{ prefixLink }}/cv/spanish\" ng-bind-html=\"cv.data.spanish.tag\"></a>\n" +
    "      </li>\n" +
    "    </ul>\n" +
    "  </div>\n" +
...
angular.module("partials/header.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("partials/header.html",
    ...
    "        <a ng-href=\"{{ prefixLink }}/\" class=\"home-link\">\n" +
...
angular.module("partials/home.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("partials/home.html",
    ...
    "      </p>\n" +
    "\n" +
    "      <a class=\"btn btn-lg btn-success\" ng-href=\"{{ prefixLink }}/cv/english\">\n" +
    "        See my CV in English…\n" +
    "      </a>\n" +
    "      <a class=\"btn btn-default jc-btn-default\" ng-href=\"{{ prefixLink }}/cv/spanish\">\n" +
    ...
    "            AngularJs Game</a>\n" +
    "          <small>\n" +
    "            <a ng-href=\"{{ prefixLink }}/game\">(play)</a>\n" +
    "          </small>\n" +
    "        </h4>\n" +
    "        <p>\n" +
...
angular.module("partials/secretary-problem.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("partials/secretary-problem.html",
    ...
    "    <a ng-href=\"{{ prefixLink }}/game/2\"   ng-class=\"{current: game.n == 2  }\">2</a>   ·\n" +
    "    <a ng-href=\"{{ prefixLink }}/game/3\"   ng-class=\"{current: game.n == 3  }\">3</a>   ·\n" +
    "    <a ng-href=\"{{ prefixLink }}/game/5\"   ng-class=\"{current: game.n == 5  }\">5</a>   ·\n" +
    "    <a ng-href=\"{{ prefixLink }}/game/10\"  ng-class=\"{current: game.n == 10 }\">10</a>  ·\n" +
    "    <a ng-href=\"{{ prefixLink }}/game/20\"  ng-class=\"{current: game.n == 20 }\">20</a>  ·\n" +
    "    <a ng-href=\"{{ prefixLink }}/game/50\"  ng-class=\"{current: game.n == 50 }\">50</a>  ·\n" +
    "    <a ng-href=\"{{ prefixLink }}/game/100\" ng-class=\"{current: game.n == 100}\">100</a> ·\n" +
    "    <a ng-href=\"{{ prefixLink }}/game/256\" ng-class=\"{current: game.n == 256}\">256</a>\n" +
    "  </p>\n" +
    "  <p class=\"visible-xs\">\n" +
