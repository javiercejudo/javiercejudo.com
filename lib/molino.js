...
const makeBuildPage = ({
  ...
  templateTransform: defaultTemplateTransform = () => identity,
} = {}) => async ({
  pageSourcePath,
  relativeOutputPath,
  ...
  data = {},
  layoutData = {},
  transformPage = defaultTemplateTransform({data}),
  transformLayout = defaultTemplateTransform({data: layoutData}),
}) => {
